import { useId, useMemo, useState, type ChangeEventHandler } from "react"
...
type PasswordProps = {
  ...
  // optionally add more RHF props like name, ref, etc.
  name?: string
}

export default function Password({ value, onChange, ...field }: PasswordProps) {
  const id = useId()
